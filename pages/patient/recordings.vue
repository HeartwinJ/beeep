...
<template>
  <div class="p-5" v-if="!isLoading">
    <div class="space-y-8">
      ...
      <div class="flex flex-col justify-center items-center gap-5" v-if="recordings?.length">
        <RecordingCard v-for="recording in recordings" :recording="recording" class="p-5n"/>
      </div>
      <div
